...
const SESSION_KEY = '@vitacare_driver_session';
const TOKEN_KEY = '@vitacare_driver_token';
const EMAIL_KEY = '@vitacare_driver_email';
const USER_ID_KEY = '@vitacare_driver_user_id';
